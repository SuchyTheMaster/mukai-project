...
- Pole wykresu pokazuje pod kursorem cienką pionową białą, półprzezroczystą i przerywaną prowadnicę, która nie przechwytuje interakcji. Podczas odtwarzania z włączonym przypinaniem lista `Sentencje` minimalnie przewija aktywny wiersz do obszaru widocznego pod panelem osi czasu; pauza albo wyłączenie przypinania zatrzymuje to przewijanie.
