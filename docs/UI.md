...
- Zaznaczona sylaba na wykresie znajduje się w warstwie nad niezaznaczonymi sylabami, dzięki czemu nachodzące bloki nie zasłaniają jej uchwytów początku i końca. Przy przeciąganiu sylaby z wciśniętym `Shift` dominujący pierwszy ruch blokuje edycję do jednej osi do końca przeciągnięcia: poziomej dla czasu albo pionowej dla tonu.
