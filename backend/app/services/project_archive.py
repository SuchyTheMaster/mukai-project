...
def _restore_job(archive: zipfile.ZipFile, manifest: dict) -> ProjectImportResponse:
    ...
    try:
        repository.create_job(
            ...
            configuration_preset=old_job.configurationPreset,
            configuration_preset_name=old_job.configurationPresetName,
            configuration_preset_type=old_job.configurationPresetType,
            configuration_fallback_fields=old_job.configurationFallbackFields,
            processing_mode=old_job.processingMode,
